...
export function Sidebar() {
  ...
  return (
    <aside 
      className={`bg-[#0B1220] border-r border-[#1E293B] flex flex-col h-full shrink-0 transition-all duration-200 z-30 select-none ${
    ...
    >
      ...
      {/* Navigation Sections */}
      <nav className="flex-1 min-h-0 p-3 space-y-6 overflow-y-auto">
      ...
      {/* Footer User Profile */}
      <div className="p-3 border-t border-[#1E293B] bg-[#060B13]/40 shrink-0">
